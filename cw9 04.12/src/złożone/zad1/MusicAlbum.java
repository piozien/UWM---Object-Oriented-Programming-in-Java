...
public class MusicAlbum {
    ...
    public void addRating(double rating) {
        ArrayList <Double> ratingsAdd = new ArrayList<>(ratings);
        ratingsAdd.add(rating);
        this.ratings = ratingsAdd;
    }
    public void removeRating(double rating){
        ArrayList<Double> ratingsRem = new ArrayList<>(ratings);
        ratingsRem.remove(rating);
        this.ratings = ratingsRem;
    }
